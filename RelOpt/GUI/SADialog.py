...
from GUI.Windows.ui_SADialog import Ui_SADialog
from Common.SysConfig import SysConfig
from Common.System import System
from Common.Module import Module
from Common.Algorithm import Algorithm
from Common.StopCondition import StopCondition 
from Algorithms.SA.SA import SA
from Algorithms.SA.SAConfig import SAConfig 

import time, os, math 
    
class SADialog(QDialog):
    ...
    def run(self):  
        ...
        algorithm = SA(self.ui.temperature.value(), self.ui.mutType.currentIndex(), self.ui.num.value(), self.ui.tempRed.currentIndex())
        SA.Zero = self.ui.Zero.value()
        if self.ui.shaking.isChecked():
            SA.shake = self.ui.shake.value()
        else:
            SA.shake = 500000
        ...
        Algorithm.result_filename = str("resultSA"+str(time.time())+".csv")
        try:
