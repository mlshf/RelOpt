...
from GUI.Windows.ui_RADialog import Ui_RADialog
from Common.SysConfig import SysConfig
from Common.System import System
from Common.Module import Module
from Common.Algorithm import Algorithm
from Common.StopCondition import StopCondition 
from Algorithms.RA.RA import RA
from Algorithms.RA.RAConfig import RAConfig
...
class RADialog(QDialog):
    ...
    def slot2(self):  
        #algorithm = RA(parameters)
        
        Algorithm.algconf = self.algconfig
        
        algorithm = RA(self.ui.comboBox.currentIndex())
        
        if self.ui.checkBox.isChecked():
            RA.spinBox_2 = self.ui.spinBox_2.value()
        else:
            RA.spinBox_2 = 500000
        ...
        Algorithm.result_filename = str("resultRA"+str(time.time())+".csv")
        try:
